...
*/	@Column(columnDefinition ="int unsigned COMMENT '用户id'")
	...
	@Column(columnDefinition = "varchar(8) NOT NULL COMMENT '用户真实姓名'  ")
	private String usersName;
	@Column(columnDefinition= "char(1) comment '备注:用户性别' ",nullable=false)
	private String usersSex;	//不允许为空
	@Column(columnDefinition = "varchar(20) NOT NULL COMMENT '生日'  ")
	...
	@Column(columnDefinition = "varchar(200) NOT NULL COMMENT '个人简介'  ")
