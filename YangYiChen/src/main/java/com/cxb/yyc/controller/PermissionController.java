...
import com.cxb.yyc.service.ConsumerService;
...
public class PermissionController {
	...
	/**
	 * http://localhost:3011/yangyichen/YangYiChen/permission/updatePermissionYang 更新系统权限信息
	 * 
	 * @author ChenYongJia
	 */
	//@PreAuthorize(value = "hasAuthority('permission:updatePermission')")
	@RequestMapping(value = "/updatePermissionYang", name = "更新系统权限",method=RequestMethod.POST)
	public String updatePermissionYang() {
