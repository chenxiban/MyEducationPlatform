...
CREATE TABLE `curriculum_tb` (
  ...
  `courses_cover` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`curriculum_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

/*Data for the table `curriculum_tb` */

insert  into `curriculum_tb`(`curriculum_id`,`course_introduction`,`creation_time`,`curriculum_category_id`,`curriculum_name`,`end_time`,`last_update_time`,`start_time`,`subscription_num`,`teacher_id`,`whether_to_issue`,`courses_cover`) values (9,'热门理工科必修课',NULL,2,'大学数学',NULL,'2018-12-21 15:08:33',NULL,0,1,0,NULL),(10,'热门文科必修课',NULL,2,'大学英语',NULL,'2018-12-21 15:09:14',NULL,0,2,0,NULL),(11,'热门文科必修课',NULL,2,'大学政治',NULL,'2018-12-21 15:09:41',NULL,0,3,0,NULL),(12,'热门选修课',NULL,1,'太极拳',NULL,'2018-12-21 15:10:07',NULL,0,4,0,NULL),(13,'热门选修课',NULL,1,'园丁教学',NULL,'2018-12-21 15:10:33',NULL,0,4,0,NULL),(14,'热门选修课',NULL,1,'电影观赏',NULL,'2018-12-21 15:10:48',NULL,0,4,0,NULL);
...
insert  into `hibernate_sequence`(`next_val`) values (4),(4),(4),(4),(4),(4);
...
insert  into `scoring_standard_tb`(`scoring_standard_id`,`curriculum_id`,`proportion`,`update_count`,`path_identity`) values (3,1,50,1,NULL);
